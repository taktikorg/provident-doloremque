...
[![npm](https://img.shields.io/npm/v/@taktikorg/provident-doloremque.svg)](https://www.npmjs.com/package/@taktikorg/provident-doloremque)
[![downloads](https://img.shields.io/npm/dt/@taktikorg/provident-doloremque.svg)](https://www.npmjs.com/package/@taktikorg/provident-doloremque)
[![types](https://img.shields.io/npm/types/@taktikorg/provident-doloremque.svg)](https://www.npmjs.com/package/@taktikorg/provident-doloremque)
[![licence](https://img.shields.io/github/license/mnasyrov/@taktikorg/provident-doloremque.svg)](https://github.com/taktikorg/provident-doloremque/blob/master/LICENSE)
[![Coverage Status](https://coveralls.io/repos/github/mnasyrov/@taktikorg/provident-doloremque/badge.svg?branch=main)](https://coveralls.io/github/mnasyrov/@taktikorg/provident-doloremque?branch=main)
...
| --------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------- |
| [**@taktikorg/provident-doloremque**][@taktikorg/provident-doloremque/docs]             | Core elements, state and effect management | [Docs][@taktikorg/provident-doloremque/docs], [API][@taktikorg/provident-doloremque/api]             |
| [**@taktikorg/provident-doloremque-react**][@taktikorg/provident-doloremque-react/docs] | Tooling for React.js                       | [Docs][@taktikorg/provident-doloremque-react/docs], [API][@taktikorg/provident-doloremque-react/api] |
...
```
npm install @taktikorg/provident-doloremque @taktikorg/provident-doloremque-react --save
```
...
import {
  ...
  Query,
  withStoreUpdates,
} from '@taktikorg/provident-doloremque';
...
import { useConst, useObservable, useQuery } from '@taktikorg/provident-doloremque-react';
...
[@taktikorg/provident-doloremque/docs]: packages/@taktikorg/provident-doloremque/README.md
[@taktikorg/provident-doloremque/api]: packages/@taktikorg/provident-doloremque/docs/README.md
[@taktikorg/provident-doloremque-react/docs]: packages/@taktikorg/provident-doloremque-react/README.md
[@taktikorg/provident-doloremque-react/api]: packages/@taktikorg/provident-doloremque-react/docs/README.md
